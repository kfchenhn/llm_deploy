export default {
  ...
  common: {
    ...
    saveTip: 'Save WHUCS-LLM conversations as images?',
  ...
  home: {
    ...
    scenariosPlaceholder:
      'Describe the service application scenarios and privatization requirements of WHUCS-LLM',
